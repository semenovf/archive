# This Makefile is for the Class::Accessor::Validated extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Class::Accessor::Validated]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Class/Accessor/Validated.pm]
#     clean => { FILES=>q[Class-Accessor-Validated-*] }
...
NAME_SYM = Class_Accessor_Validated
VERSION = 0.01
...
MAKE = make
FULLEXT = Class/Accessor/Validated
BASEEXT = Validated
PARENT_NAME = Class::Accessor
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Class/Accessor/Validated.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Class/Accessor
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Class/Accessor
...
DISTNAME = Class-Accessor-Validated
DISTVNAME = Class-Accessor-Validated-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Class/Accessor/Validated.pm $(INST_MAN3DIR)/Class::Accessor::Validated.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Class-Accessor-Validated' >> META_new.yml
