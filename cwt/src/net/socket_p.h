...
extern ssize_t    __socket_readLocalSocket  (CwtSocket*, CwtByteArray *ba, size_t sz);
extern ssize_t    __socket_readTcpSocket    (CwtSocket*, CwtByteArray *ba, size_t sz);
extern ssize_t    __socket_readUdpSocket    (CwtSocket*, CwtByteArray *ba, size_t sz);
extern ssize_t    __socket_readMcastSocket  (CwtSocket*, CwtByteArray *ba, size_t sz);
