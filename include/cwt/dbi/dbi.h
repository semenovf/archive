...
typedef struct CwtDBI
{
	...
	CwtDBHandler (*connect)       (const CWT_CHAR *dsn, const CWT_CHAR *username, const CWT_CHAR *password);
...
/*CwtDBHandler (*connectCached) (const CHAR *dsn, const CHAR *username, const CHAR *password);*/
