#ifndef __HIBERLITE_DATABASE_TMPL_IMPL_HPP__
#define __HIBERLITE_DATABASE_TMPL_IMPL_HPP__
...
template<class C>
void Database::dbDeleteRows (cwt::debby::database con, const pfs::string & table, const pfs::string & column, C value)
{
	pfs::string query;
	query << "DELETE FROM " << table
		<< " WHERE " << column << "=" << pfs::stringify(value) << ";";
...
#endif // __HIBERLITE_DATABASE_TMPL_IMPL_HPP__
