#ifndef __HIBERLITE_NVP_H__
#define __HIBERLITE_NVP_H__
...
public:
	...
	virtual void bindValue (cwt::debby::statement stmt, size_t col) = 0;
...
public:
	...
	inline pfs::string sqliteStorageClass ();

//	template<class Stmt,class Arg>
//	void loadValue (Stmt & res, Arg & arg);

	//inline virtual void bindValue (sqlite3_stmt* stmt, int col);
	inline virtual void bindValue (cwt::debby::statement & stmt, size_t col);
};

} //namespace hiberlite

#endif // __HIBERLITE_NVP_H__
