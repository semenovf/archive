...
#define FSM_MATCH_SEQ(n)                 cwt::fsm::match<pfs::string>(new cwt::fsm::match_seq<pfs::string>(n))
#define FSM_MATCH_RANGE(min,max)         cwt::fsm::match<pfs::string>(new cwt::fsm::match_range<pfs::string>(min,max))
#define FSM_MATCH_RPT_RANGE(min,max,f,t) cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_RANGE(min,max),(f),(t)))
#define FSM_MATCH_OPT_RANGE(min,max)     cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_RANGE(min,max),0,1))
#define FSM_MATCH_FSM(tr)                cwt::fsm::match<pfs::string>(new cwt::fsm::match_fsm<pfs::string>(tr))
#define FSM_MATCH_RPT_FSM(tr,f,t)        cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_FSM(tr),(f),(t)))
#define FSM_MATCH_OPT_FSM(tr)            cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_FSM(tr),0,1))
#define FSM_MATCH_FUNC(fn,pcont)         cwt::fsm::match<pfs::string>(new cwt::fsm::match_func<pfs::string>(fn,pcont))
#define FSM_MATCH_RPT_FUNC(fn,pcont,f,t) cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_FUNC(fn,pcont),(f),(t)))
#define FSM_MATCH_OPT_FUNC(fn,pcont)     cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_FUNC(fn,pcont),0,1))
#define FSM_MATCH_NOTHING                cwt::fsm::match<pfs::string>(new cwt::fsm::match_nothing<pfs::string>)
#define FSM_MATCH_CHAR(s)                cwt::fsm::match<pfs::string>(new cwt::fsm::match_char<pfs::string>(s))
#define FSM_MATCH_STR(s)                 cwt::fsm::match<pfs::string>(new cwt::fsm::match_str<pfs::string>(s))
#define FSM_MATCH_RPT_STR(s,f,t)         cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_STR(s),f,t))
#define FSM_MATCH_OPT_STR(s)             cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_STR(s),0,1))
#define FSM_MATCH_RPT_CHAR(s,f,t)        cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_CHAR(s),f,t))
#define FSM_MATCH_OPT_CHAR(s)            cwt::fsm::match<pfs::string>(new cwt::fsm::match_rpt<pfs::string>(FSM_MATCH_CHAR(s),0,1))
