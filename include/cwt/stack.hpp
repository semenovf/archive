...
{ CWT_ASSERT(!this->isEmpty()); T t = this->data()[this->size() -1]; this->resize(this->size()-1); return t; }

template<typename T>
inline T &Stack<T>::top()
{ CWT_ASSERT(!this->isEmpty()); Vector<T>::__impl.detach(); return this->data()[this->size()-1]; }
