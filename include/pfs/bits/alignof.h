...
template <> struct types<0> {
    typedef char          Type;
};
template <> struct types<1> {
    typedef short         Type;
};
template <> struct types<2> {
    typedef int           Type;
};
template <> struct types<3> {
    typedef long          Type;
};
template <> struct types<4> {
    typedef float         Type;
};
template <> struct types<5> {
    typedef double        Type;
};
template <> struct types<6> {
    typedef long double   Type;
};
template <> struct types<7> {
    typedef void     *    Type;
};
template <> struct types<8> {
    typedef void (*Type) (void);
};
template <> struct types<9> {
    typedef Unknown (Unknown::*Type) (Unknown);
};
