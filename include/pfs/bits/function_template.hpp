...
#	define PFS_FUNCTION_MEMBER_ARGS           PFS_JOIN_ARGS(PFS_FUNCTION_ARGS_NUM,a)
#else
...
/*
#undef PFS_FUNCTION_MEMBER_COMMA
#if PFS_FUNCTION_ARGS_NUM > 1
#	define 	PFS_FUNCTION_MEMBER_COMMA ,
#else
#	define 	PFS_FUNCTION_MEMBER_COMMA
#endif
*/
