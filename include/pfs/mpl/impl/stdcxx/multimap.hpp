...
#ifndef __PFS_MPL_STDCXX_MULTIMAP_HPP__
#define __PFS_MPL_STDCXX_MULTIMAP_HPP__
...
template <typename Key, typename T>
struct multimap_iterator : public multimap<Key, T>::type::iterator
{
    typedef typename multimap<Key, T>::type::iterator base_type;
...
template <typename Key, typename T>
struct multimap_const_iterator : public multimap<Key, T>::type::const_iterator
{
    typedef typename multimap<Key, T>::type::const_iterator base_type;
...
#endif /* __PFS_MPL_STDCXX_MULTIMAP_HPP__ */
