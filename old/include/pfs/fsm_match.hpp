...
public:
	...
	virtual ~match_seq () {}
	virtual ssize_t do_match (context<_P> *, const const_iterator & begin, const const_iterator & end) const
	{
...
public:
	...
	virtual ~match_fsm () {}
	virtual ssize_t do_match(context<_P> * ctx, const const_iterator & begin, const const_iterator & end) const
	{
...
public:
	...
	virtual ~match_rpt() {}
	virtual ssize_t do_match (context<_P> * ctx, const const_iterator & begin, const const_iterator & end) const override;
...
template <typename _P>
ssize_t match_rpt<_P>::do_match (context<_P> * ctx, const const_iterator & begin, const const_iterator & end) const
{
	int from = 0;
	int to = PFS_INT_MAX;
...
public:
	...
	virtual ssize_t do_match (context<_P> *, const const_iterator & , const const_iterator & ) const
	{
		return 0;
	}
};
