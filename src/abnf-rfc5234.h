...
static CwtFsmTransition prose_val_opt_fsm[] = {
...
static CwtFsmTransition prose_val_fsm[] = {
	...
	, { 2,-1, FSM_MATCH_RPT(prose_val_opt_fsm, &rpt_0more) , FSM_NORMAL, NULL, NULL }
	, {-1,-1, FSM_MATCH_STR(_T(">"), 1)                    , FSM_ACCEPT, NULL, NULL }
};


/* ALPHA *(ALPHA / DIGIT / "-") */
static CwtFsmTransition rulename_opt_fsm[] = {
...
static CwtFsmTransition rulename_fsm[] = {
    ...
    , {-1,-1, FSM_MATCH_RPT(rulename_opt_fsm, &rpt_0more) , FSM_ACCEPT, NULL, NULL }
};


/* ";" *(WSP / VCHAR) NL */
static CwtFsmTransition wsp_vchar_fsm[] = {
	  {-1, 1, FSM_MATCH_INLINE(WSP_FSM_INL),   FSM_ACCEPT, NULL, NULL }
	, {-1,-1, FSM_MATCH_INLINE(VCHAR_FSM_INL), FSM_ACCEPT, NULL, NULL }
};
...
static CwtFsmTransition char_val_opt_fsm[] = {
...
static CwtFsmTransition char_val_fsm[] = {
	...
	, { 2,-1, FSM_MATCH_RPT(char_val_opt_fsm, &rpt_0more) , FSM_NORMAL, NULL, NULL }
...
/* "." 1*BIT */
/* "-" 1*BIT */
static CwtFsmTransition bin_dash_fsm[] = {
	  { 1,-1, FSM_MATCH_CHAR(_T("-"), 1)         , FSM_NORMAL , NULL, NULL }
	, {-1,-1, FSM_MATCH_RPT(BIT_FSM, &rpt_1more) , FSM_ACCEPT , NULL, NULL }
};
static CwtFsmTransition bin_point_fsm[] = {
	  { 1,-1, FSM_MATCH_CHAR(_T("."), 1)         , FSM_NORMAL , NULL, NULL }
	, {-1,-1, FSM_MATCH_RPT(BIT_FSM, &rpt_1more) , FSM_ACCEPT , NULL, NULL }
};
static CwtFsmTransition bin_dash_point_fsm[] = {
	  {-1, 1, FSM_MATCH_FSM(bin_dash_fsm)              , FSM_ACCEPT , NULL, NULL }
	, {-1,-1, FSM_MATCH_RPT(bin_point_fsm, &rpt_1more) , FSM_ACCEPT , NULL, NULL }
};
static CwtFsmTransition bin_val_fsm[] = {
	  { 1,-1, FSM_MATCH_CHAR(_T("b"), 1)         , FSM_NORMAL , NULL, NULL }
	, { 2,-1, FSM_MATCH_RPT(BIT_FSM, &rpt_1more) , FSM_ACCEPT , NULL, NULL }
	, { 3, 3, FSM_MATCH_FSM(bin_dash_point_fsm)  , FSM_NORMAL , NULL, NULL }
...
static CwtFsmTransition dec_dash_point_fsm[] = {
...
static CwtFsmTransition hex_dash_point_fsm[] = {
...
static CwtFsmTransition num_val_opt_fsm[] = {
...
/* WSP / (c-nl WSP) */
/* c-nl WSP */
static CwtFsmTransition c_nl_wsp_fsm[] = {
...
/*
  *c-wsp ("=" / "=/") *c-wsp
							...
							;  incremental alternatives
*/
static CwtFsmTransition assign_fsm[] = {
