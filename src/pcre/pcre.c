...
extern int              pcre_dfa_exec                (const pcre*, const pcre_extra*, const char*, int, int, unsigned int, int*, int , int*, int);
extern int              pcre_exec                    (const pcre*, const pcre_extra*, PCRE_SPTR, int, int, unsigned int, int*, int);
