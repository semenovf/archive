...
static FsmTransition<String> unreserved_fsm[] = {
    ...
    , {-1,-1, FSM_MATCH_CHAR("-._~")     , FSM_ACCEPT, nullptr, nullptr }
};
...
static FsmTransition<String> dec_octet_fsm_4[] = {
	  { 1,-1, FSM_MATCH_STR("25")      , FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_CHAR("012345") , FSM_ACCEPT, nullptr, nullptr }
};

/* "2" %x30-34 DIGIT   ; 200-249 */
static FsmTransition<String> dec_octet_fsm_3[] = {
	  { 1,-1, FSM_MATCH_STR("2")        , FSM_NORMAL, nullptr, nullptr }
	, { 2,-1, FSM_MATCH_CHAR("01234")   , FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_CHAR(_URI_DIGIT), FSM_ACCEPT, nullptr, nullptr }
};

/* "1" 2DIGIT  ; 100-199 */
static FsmTransition<String> dec_octet_fsm_2[] = {
	  { 1,-1, FSM_MATCH_STR("1")        , FSM_NORMAL, nullptr, nullptr }
...
static FsmTransition<String> ipv4address_fsm[] = {
	...
	, { 2,-1, FSM_MATCH_STR(".")          , FSM_NORMAL, nullptr, nullptr }
	, { 3,-1, FSM_MATCH_FSM(dec_octet_fsm), FSM_NORMAL, nullptr, nullptr }
	, { 4,-1, FSM_MATCH_STR(".")          , FSM_NORMAL, nullptr, nullptr }
	, { 5,-1, FSM_MATCH_FSM(dec_octet_fsm), FSM_NORMAL, nullptr, nullptr }
	, { 6,-1, FSM_MATCH_STR(".")          , FSM_NORMAL, nullptr, nullptr }
...
static FsmTransition<String> ls32_fsm[] = {
	...
	, { 3,-1, FSM_MATCH_STR(":")            , FSM_NORMAL, nullptr, nullptr }
...
static FsmTransition<String> ipv6address_fsm_7[] = {
	...
	, { 5,-1, FSM_MATCH_STR("::")     , FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_FSM(ls32_fsm) , FSM_ACCEPT, nullptr, nullptr }
};
...
static FsmTransition<String> ipvfuture_fsm[] = {
      { 1,-1, FSM_MATCH_STR("v")                          , FSM_NORMAL, nullptr, nullptr }
...
static FsmTransition<String> userinfo_fsm[] = {
	...
	, { 0, 4, FSM_MATCH_STR(":")            , FSM_ACCEPT, __TRACE_ACT, __TRACE_ARGS("userinfo_fsm: FSM_MATCH_STR(:)") }
...
static FsmTransition<String> relative_part_fsm[] = {
	  { 1, 3, FSM_MATCH_STR("//")            , FSM_NORMAL, nullptr, nullptr }
