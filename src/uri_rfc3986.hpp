...
static fsm::transition<pfs::string> digit_fsm[] = {
    {-1,-1, FSM_MATCH_CHAR(_URI_DIGIT), FSM_ACCEPT, nullptr, nullptr }
};

static fsm::transition<pfs::string> hexdig_fsm[] = {
    {-1,-1, FSM_MATCH_CHAR(_URI_HEXDIGIT), FSM_ACCEPT, nullptr, nullptr }
};

/* ALPHA / DIGIT / "-" / "." / "_" / "~" */
static fsm::transition<pfs::string> unreserved_fsm[] = {
...
/* "%" HEXDIG HEXDIG */
static fsm::transition<pfs::string> pct_encoded_fsm[] = {
...
/* "!" / "$" / "&" / "'" / "(" / ")"
       / "*" / "+" / "," / ";" / "="
*/
static fsm::transition<pfs::string> sub_delims_fsm[] = {
    {-1,-1, FSM_MATCH_CHAR(_u8("!$&'()*+,;=")), FSM_ACCEPT, nullptr, nullptr }
};

/* unreserved / pct-encoded / sub-delims / ":" / "@" */
static fsm::transition<pfs::string> pchar_fsm[] = {
...
/* "/" [ segment-nz *slash_segment ] */
static fsm::transition<pfs::string> path_absolute_fsm[] = {
	  { 1,-1, FSM_MATCH_STR(_u8("/"))                 , FSM_NORMAL, nullptr, nullptr }
...
/* 1*( unreserved / pct-encoded / sub-delims / "@" )
   		; non-zero-length segment without any colon ":"
*/
static fsm::transition<pfs::string> segment_nc_fsm[] = {
      {-1, 1, FSM_MATCH_FSM(unreserved_fsm) , FSM_ACCEPT, nullptr, nullptr }
    , {-1, 2, FSM_MATCH_FSM(pct_encoded_fsm), FSM_ACCEPT, nullptr, nullptr }
    , {-1, 3, FSM_MATCH_FSM(sub_delims_fsm) , FSM_ACCEPT, nullptr, nullptr }
    , {-1,-1, FSM_MATCH_CHAR(_u8("@"))      , FSM_ACCEPT, nullptr, nullptr }
...
static fsm::transition<pfs::string> segment_nz_nc_fsm[] = {
    {-1,-1, FSM_MATCH_RPT_FSM(segment_nc_fsm, 1, -1),  FSM_ACCEPT, nullptr, nullptr }
};

/* segment-nz-nc *slash-segment */
static fsm::transition<pfs::string> path_noscheme_fsm[] = {
      { 1,-1, FSM_MATCH_FSM(segment_nz_nc_fsm), FSM_ACCEPT, nullptr, nullptr }
    , {-1,-1, FSM_MATCH_RPT_FSM(slash_segment_fsm, 0, -1), FSM_ACCEPT, nullptr, nullptr }
};

/* 0<pchar> */
static fsm::transition<pfs::string> path_empty_fsm[] = {
    {-1,-1, FSM_MATCH_NOTHING, FSM_ACCEPT, nullptr, nullptr }
};

/* 1*4HEXDIG */
static fsm::transition<pfs::string> h16_fsm[] = {
	  { 1,-1, FSM_MATCH_CHAR(_URI_HEXDIGIT), FSM_ACCEPT, nullptr, nullptr }
...
/* "1" 2DIGIT  ; 100-199 */
static fsm::transition<pfs::string> dec_octet_fsm_2[] = {
...
/* %x31-39 DIGIT       ; 10-99*/
static fsm::transition<pfs::string> dec_octet_fsm_1[] = {
...
/*
  ...
  / "25" %x30-35        ; 250-255
*/
static fsm::transition<pfs::string> dec_octet_fsm[] = {
...
static fsm::transition<pfs::string> ipv4address_fsm[] = {
...
/* ( h16 ":" h16 ) / IPv4address */
static fsm::transition<pfs::string> ls32_fsm[] = {
...
/* *2( h16 ":" ) h16 */
static fsm::transition<pfs::string> ipv6address_fsm_5_1[] = {
...
/* *3( h16 ":" ) h16 */
static fsm::transition<pfs::string> ipv6address_fsm_6_1[] = {
...
/* *4( h16 ":" ) h16 */
static fsm::transition<pfs::string> ipv6address_fsm_7_1[] = {
...
/* *5( h16 ":" ) h16 */
static fsm::transition<pfs::string> ipv6address_fsm_8_1[] = {
...
/* *6( h16 ":" ) h16 */
static fsm::transition<pfs::string> ipv6address_fsm_9_1[] = {
...
/* [ h16 ] "::" 4( h16 ":" ) ls32 */
static fsm::transition<pfs::string> ipv6address_fsm_3[] = {
      { 1, 1, FSM_MATCH_FSM(h16_fsm)               , FSM_NORMAL, nullptr, nullptr }
    , { 2,-1, FSM_MATCH_STR(_u8("::"))             , FSM_NORMAL, nullptr, nullptr }
...
/* [ *1( h16 ":" ) h16 ] "::" 3( h16 ":" ) ls32 */
static fsm::transition<pfs::string> ipv6address_fsm_4[] = {
...
/* [ *2( h16 ":" ) h16 ] "::" 2( h16 ":" ) ls32 */
static fsm::transition<pfs::string> ipv6address_fsm_5[] = {
...
/* [ *3( h16 ":" ) h16 ] "::" h16 ":"   ls32 */
static fsm::transition<pfs::string> ipv6address_fsm_6[] = {
...
/* [ *4( h16 ":" ) h16 ] "::" ls32 */
static fsm::transition<pfs::string> ipv6address_fsm_7[] = {
...
/* [ *5( h16 ":" ) h16 ] "::"              h16 */
static fsm::transition<pfs::string> ipv6address_fsm_8[] = {
...
/* [ *6( h16 ":" ) h16 ] "::" */
static fsm::transition<pfs::string> ipv6address_fsm_9[] = {
...
/*
	...
	/ [ *6( h16 ":" ) h16 ] "::"
*/
static fsm::transition<pfs::string> ipv6address_fsm[] = {
...
static fsm::transition<pfs::string> ipvfuture_tail_fsm[] = {
	  {-1, 1, FSM_MATCH_FSM(unreserved_fsm), FSM_ACCEPT, nullptr, nullptr }
	, {-1, 2, FSM_MATCH_FSM(sub_delims_fsm), FSM_ACCEPT, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_STR(_u8(":"))      , FSM_ACCEPT, nullptr, nullptr }
};

static fsm::transition<pfs::string> ipvfuture_fsm[] = {
...
/* *( unreserved / pct-encoded / sub-delims ) */
static fsm::transition<pfs::string> reg_name_entry_fsm[] = {
      {-1, 1, FSM_MATCH_FSM(unreserved_fsm),  FSM_ACCEPT, nullptr, nullptr }
    , {-1, 2, FSM_MATCH_FSM(pct_encoded_fsm), FSM_ACCEPT, nullptr, nullptr }
    , {-1,-1, FSM_MATCH_FSM(sub_delims_fsm),  FSM_ACCEPT, nullptr, nullptr }
};
static fsm::transition<pfs::string> reg_name_fsm[] = {
      {-1,-1, FSM_MATCH_RPT_FSM(reg_name_entry_fsm, 0, -1), FSM_ACCEPT, nullptr, nullptr }
};

/*  host = IP-literal / IPv4address / reg-name */
static fsm::transition<pfs::string> host_fsm[] = {
...
/* *DIGIT */
static fsm::transition<pfs::string> port_fsm[] = {
      {-1,-1, FSM_MATCH_RPT_FSM(digit_fsm, 0, -1), FSM_ACCEPT, nullptr, nullptr }
};

/* ":" port */
static fsm::transition<pfs::string> authority_fsm_2[] = {
	  { 1,-1, FSM_MATCH_STR(_u8(":")), FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_FSM(port_fsm), FSM_ACCEPT, set_port, nullptr}
};

/* *( unreserved / pct-encoded / sub-delims / ":" ) */
static fsm::transition<pfs::string> userinfo_fsm[] = {
...
/* userinfo "@" */
static fsm::transition<pfs::string> authority_fsm_1[] = {
...
static fsm::transition<pfs::string> authority_fsm[] = {
...
/*  *( "/" segment ) */
static fsm::transition<pfs::string> path_abempty_fsm[] = {
      {-1,-1, FSM_MATCH_RPT_FSM(slash_segment_fsm, 0, -1), FSM_ACCEPT, nullptr, nullptr }
};
...
relative-part = "//" authority path-abempty
              ...
              / path-empty
*/
static fsm::transition<pfs::string> relative_part_fsm[] = {
...
/* *( pchar / "/" / "?" ) */
static fsm::transition<pfs::string> query_chars_fsm[] = {
	  {-1, 1, FSM_MATCH_FSM(pchar_fsm)  , FSM_ACCEPT, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_CHAR(_u8("/?")) , FSM_ACCEPT, nullptr, nullptr }
};
static fsm::transition<pfs::string> query_fsm[] = {
    {-1,-1, FSM_MATCH_RPT_FSM(query_chars_fsm, 0, -1), FSM_ACCEPT, nullptr, nullptr }
};

/* "?" query */
static fsm::transition<pfs::string> relative_ref_fsm_1[] = {
	  { 1,-1, FSM_MATCH_STR(_u8("?")) , FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_FSM(query_fsm), FSM_ACCEPT, set_query, nullptr }
};

/* *( pchar / "/" / "?" ) */
static fsm::transition<pfs::string> fragment_fsm[] = {
	{-1,-1, FSM_MATCH_RPT_FSM(query_chars_fsm, 0, -1), FSM_ACCEPT, nullptr, nullptr }
};

/* "#" fragment */
static fsm::transition<pfs::string> relative_ref_fsm_2[] = {
	  { 1,-1, FSM_MATCH_STR(_u8("#"))    , FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_FSM(fragment_fsm), FSM_ACCEPT, set_fragment, nullptr}
};

/* relative-part [ "?" query ] [ "#" fragment ] */
static fsm::transition<pfs::string> relative_ref_fsm[] = {
...
/* ALPHA *( ALPHA / DIGIT / "+" / "-" / "." ) */
static fsm::transition<pfs::string> scheme_chars_fsm[] = {
	  {-1, 1, FSM_MATCH_CHAR(_URI_ALPHA) , FSM_ACCEPT, nullptr, nullptr }
	, {-1, 2, FSM_MATCH_CHAR(_URI_DIGIT) , FSM_ACCEPT, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_CHAR(_u8("+-.")) , FSM_ACCEPT, nullptr, nullptr }
};
static fsm::transition<pfs::string> scheme_fsm[] = {
...
/* segment-nz *( "/" segment ) */
static fsm::transition<pfs::string> path_rootless_fsm[] = {
...
/*
    "//" authority path-abempty
	 	 ...
	 	 / path-empty
*/
static fsm::transition<pfs::string> hier_part_fsm[] = {
	  { 1, 3, FSM_MATCH_STR(_u8("//"))       , FSM_NORMAL, nullptr, nullptr }
	, { 2, 3, FSM_MATCH_FSM(authority_fsm)   , FSM_NORMAL, set_path, nullptr }
	, {-1, 3, FSM_MATCH_FSM(path_abempty_fsm), FSM_ACCEPT, set_path, nullptr }
...
/* "?" query */
static fsm::transition<pfs::string> uri_fsm_1[] = {
	  { 1,-1, FSM_MATCH_STR(_u8("?")) , FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_FSM(query_fsm), FSM_ACCEPT, set_query, nullptr }
};

/* "#" fragment */
static fsm::transition<pfs::string> uri_fsm_2[] = {
	  { 1,-1, FSM_MATCH_STR(_u8("#"))    , FSM_NORMAL, nullptr, nullptr }
	, {-1,-1, FSM_MATCH_FSM(fragment_fsm), FSM_ACCEPT, set_fragment, nullptr }
};
...
static fsm::transition<pfs::string> uri_fsm[] = {
...
/* URI / relative-ref */
static fsm::transition<pfs::string> uri_reference_fsm[] = {
