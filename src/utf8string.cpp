...
/*
utf8string & utf8string::replace (const_iterator i1, const_iterator i2, const_iterator first, const_iterator last)
{
	detach();
	...
	_pimpl->replace(off, size, first.base().ptr(), 0, last.distance(first));
	this->updateLength();
	return *this;
}
*/
