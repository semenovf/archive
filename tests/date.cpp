...
void test_jd (void)
{
	...
	TEST_OK2(d1.isValid(), "13.9.2013 - 10000000 is a valid date and it is 27.2.25366 BC");
	TEST_OK2(d2.isValid(), "27.2.25366 BC is valid date");
	TEST_OK2(!pfs::date(-25365, 2, 30).isValid(), "30.2.25365 BC is invalid date");
...
{
	 TEST_OK2(pfs::date::isValid(2002, 5, 17)   , "17.05.2002 is a valid date");  // true
	 TEST_OK2(! pfs::date::isValid(2002, 2, 30) , "30.02.2002 is not a valid date: Feb 30 does not exist");
	 TEST_OK2(pfs::date::isValid(2004, 2, 29)   , "29.02.2004 is a valid date: 2004 is a leap year");
	 TEST_OK2(pfs::date::isValid(2000, 2, 29)   , "29.02.2004 is a valid date: 2000 is a leap year");
	 TEST_OK2(! pfs::date::isValid(2006, 2, 29) , "29.02.2006 is not a valid date: 2006 is not a leap year");
	 TEST_OK2(! pfs::date::isValid(2100, 2, 29) , "29.02.2100 is not a valid date: 2100 is not a leap year");
	 TEST_OK2(pfs::date::isValid(1202, 6, 6)    , "06.06.1202 is a valid date: even though 1202 is pre-Gregorian");
...
void test_periods (void)
{
	 ...
	 TEST_OK2(d1.daysTo(d2) == 3, "Days bitween 17.05.1995 and 20.05.1995 is 3");
	 TEST_OK2(d2.daysTo(d1) == -3, "Days bitween 20.05.1995 and 17.05.1995 is -3");
}
