...
void test_iterator ()
{
    typedef pfs::cli::details::cmdline<char const *> cmdline;
    ...
    TEST_OK(it != end);
    TEST_OK(std::strcmp(*it++, "domain") == 0);
    TEST_OK(std::strcmp(*it++, "command") == 0);
    TEST_OK(std::strcmp(*it++, "-a") == 0);
    TEST_OK(std::strcmp(*it++, "-bcd") == 0);
    TEST_OK(std::strcmp(*it++, "--option1") == 0);
    TEST_OK(std::strcmp(*it++, "--option2=option2_arg") == 0);
    TEST_OK(std::strcmp(*it++, "--option 3=option3 arg") == 0);
    TEST_OK(std::strcmp(*it++, "--") == 0);
    TEST_OK(std::strcmp(*it++, "arg1") == 0);
    TEST_OK(std::strcmp(*it++, "--arg2") == 0);
    TEST_OK(it == end);
}
...
void test_tokenizer ()
{
    ...
    cl.set_shortopt_prefix("-");
    cl.set_longopt_prefix("--");
    cl.set_argument_separator("--");
